...
You can customize all components via configuring the Whisk SDK Theme with CSS classes, or with [tailwindCSS](https://tailwindcss.com/) using the className prop. 
